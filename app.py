...
def get_translations():
    ...
    translations = {
        'en': {
            ...
            'lang-compress-docx-title': 'Compress DOCX',
            'lang-compress-docx-desc': 'Convert DOCX to a compressed PDF (Smallest Size)',
            'lang-compress-docx-input-label': 'Select DOCX file',
            'lang-compressing-docx': 'Compressing DOCX...',
            'lang-compress-docx-btn': 'Compress DOCX',
        },
        'vi': {
            ...
            'lang-compress-docx-title': 'Nén DOCX',
            'lang-compress-docx-desc': 'Chuyển đổi DOCX thành PDF được nén (Kích thước nhỏ nhất)',
            'lang-compress-docx-input-label': 'Chọn tệp DOCX',
            'lang-compressing-docx': 'Đang nén DOCX...',
            'lang-compress-docx-btn': 'Nén DOCX',
        }
    }
